...
public class ValidationQuoteDao {
	...
	public ValidationQuote addValidattionQuote(HttpSession hsession) {
		...
		Property userProp = (Property)session.get(Property.class,id);
		Location userLoc = (Location)session.get(Location.class,id);
	...
	public static double calculatePremium(HttpSession hsession, double dwelling_coverage, Session session,Location userLoc ) {
	...
	public static double calculateDwellingCoverage(HttpSession hsession, Session session,Property userProp) {
	...
	public static double calculatedeductible(HttpSession hsession, Session session,Property userProp) {
